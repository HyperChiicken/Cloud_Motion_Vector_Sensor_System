ccc;                                                                        %clc, clear all, close all 
%% Load CSV files
filepath = 'C:/insertfilepathhere/2018-04-19CMV.csv';     %set folder location to save figures
save_filepath = 'D:/insertfilepathhere/test/'; 
...
%% Get framed dataset
data_sample = getFrame(data,x_start,x_end);
...
% OpF = getOpticalFlow(imData);
% getVid(OpF,strcat(save_filepath,'OpticalFlow'));                          %save OpF run as .AVI file
